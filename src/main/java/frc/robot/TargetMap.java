...
public class TargetMap {
  ...
  public static Pose2d[] redChargeingPose2bot = new Pose2d[2];
    ...
    TargetMap() {
      ...
      coneArmTargets[2] = new Translation2d(0.25, 0.25); //0
      coneArmTargets[1] = new Translation2d(0.61, 0.97); //87 4inchs higher
      coneArmTargets[0] = new Translation2d(1.01, 1.27); //117 4inchs higher

      cubeArmTargets[2] = new Translation2d(0.25, 0.25); //0
      cubeArmTargets[1] = new Translation2d(0.61, 0.75); //60 6inchs higher
      cubeArmTargets[0] = new Translation2d(1.01, 1.05); //90 6inchs higher
