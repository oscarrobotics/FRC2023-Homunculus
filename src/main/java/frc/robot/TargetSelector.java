...
public class TargetSelector implements Loggable {
    ...
    @Log.BooleanBox(rowIndex = 1, columnIndex = 1, tabName = tabname)
    static boolean backleftA = false;
    
    @Log.BooleanBox(rowIndex = 1, columnIndex = 2, tabName = tabname)
   static  boolean backcenterA = false;
    @Log.BooleanBox(rowIndex = 1, columnIndex = 3, tabName = tabname)
   static  boolean backrightA = false;
    @Log.BooleanBox(rowIndex = 2, columnIndex = 1, tabName = tabname)
   static  boolean midleftA = false;
    @Log.BooleanBox(rowIndex = 2, columnIndex = 2, tabName = tabname)
   static  boolean midcenterA = false;
    @Log.BooleanBox(rowIndex = 2, columnIndex = 3, tabName = tabname)
   static  boolean midrightA = false;
    @Log.BooleanBox(rowIndex = 3, columnIndex = 1, tabName = tabname)
   static  boolean frontleftA = false;
    @Log.BooleanBox(rowIndex = 3, columnIndex = 2, tabName = tabname)
   static  boolean frontcenterA = false;
    @Log.BooleanBox(rowIndex = 3, columnIndex = 3, tabName = tabname)
   static  boolean frontrightA = false;
  
    @Log.BooleanBox(rowIndex = 1, columnIndex = 5, tabName = tabname)
   static  boolean backleftB = false;
    @Log.BooleanBox(rowIndex = 1, columnIndex = 6, tabName = tabname)
   static  boolean backcenterB = false;
    @Log.BooleanBox(rowIndex = 1, columnIndex = 7, tabName = tabname)
   static  boolean backrightB = false;
    @Log.BooleanBox(rowIndex = 2, columnIndex = 5, tabName = tabname)
   static  boolean midleftB = false;
    @Log.BooleanBox(rowIndex = 2, columnIndex = 6, tabName = tabname)
   static  boolean midcenterB = false;
    @Log.BooleanBox(rowIndex = 2, columnIndex = 7, tabName = tabname)
   static  boolean midrightB = false;
    @Log.BooleanBox(rowIndex = 3, columnIndex = 5, tabName = tabname)
   static  boolean frontleftB = false;
    @Log.BooleanBox(rowIndex = 3, columnIndex = 6, tabName = tabname)
   static  boolean frontcenterB = false;
    @Log.BooleanBox(rowIndex = 3, columnIndex = 7, tabName = tabname)
   static  boolean frontrightB = false;
  
    @Log.BooleanBox(rowIndex = 1, columnIndex = 9, tabName = tabname)
   static  boolean backleftC = false;
    @Log.BooleanBox(rowIndex = 1, columnIndex = 10, tabName = tabname)
   static  boolean backcenterC = false;
    @Log.BooleanBox(rowIndex = 1, columnIndex = 11, tabName = tabname)
   static  boolean backrightC = false;
    @Log.BooleanBox(rowIndex = 2, columnIndex = 9, tabName = tabname)
   static  boolean midleftC = false;
    @Log.BooleanBox(rowIndex = 2, columnIndex = 10, tabName = tabname)
   static  boolean midcenterC = false;
    @Log.BooleanBox(rowIndex = 2, columnIndex = 11, tabName = tabname)
   static  boolean midrightC = false;
    @Log.BooleanBox(rowIndex = 3, columnIndex = 9, tabName = tabname)
   static  boolean frontleftC = false;
    @Log.BooleanBox(rowIndex = 3, columnIndex = 10, tabName = tabname)
   static  boolean frontcenterC = false;
    @Log.BooleanBox(rowIndex = 3, columnIndex = 11, tabName = tabname)
