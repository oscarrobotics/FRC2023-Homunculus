...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    /*I'm considering just pulling out the talon directly, 
    but it'll be encoder methods copy and paste central. I could create
    A new class but is the abstraction worth it I wonder*/
